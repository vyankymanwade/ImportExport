...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Supplier</span>
</div>
...
<!--              <a id="divshow" href="#" class="w3-bar-item w3-button w3-padding" onclick="showsuppliertable()"><i class="	fa fa-handshake-o"></i></a>-->
<!--      <a href="#" class="w3-bar-item w3-button w3-padding" onclick="showstockdetails()"><i class="		fa fa-cubes"></i></a>-->
...
<button class="button button3"style="float: right;"onclick="document.getElementById('id01').style.display='block'">Add OR Update Commodity</button></b></h5>
    ...
    <table id="supliertable" style="display:none">
        <tr><th><h3 style="visibility:visible">Order Details</h3></th></tr>
      
         <?php
        
            include "supplierOrderRequestDisplay.php";
...
<table id="stockdetails" style="display:none">
        <tr><th><h3 style="visibility:visible">'s Stock Details</h3></th></tr>
        <?php
        
            include "supplierStockDisplay.php";
...
<!-- Add new Commodity Form -->
  ...
  <form class="modal-content" action="addQuantity.php" method="post">
    <div class="container">
      ...
      <div class="clearfix">
        <button type="submit" class="updatebtn" name="submit">Add / Update Commodity</button>
      </div>
    </div>
  </form>
</div>
    ...
    function showdistributortable(hide){
        ...
        lTable.style.display = (lTable.style.display == "table") ? "none" : "table";
            ...
            function showstockdetails(hide){
